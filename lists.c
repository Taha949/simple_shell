 ...
 * @num: index du nœud utilisé par l'historique
 *
...
/**
 * print_list_str - n'affiche que l'élément str d'une liste chaînée list_t
...
/**
 * delete_node_at_index - supprime le nœud à l'indice donné
 * @head: adresse du pointeur vers le premier nœud
 ...
 * @head_ptr: adresse du pointeur vers le premier nœud
 *
 * Return: void
 */
